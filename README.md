...
** Specs
I'm testing the scenarios that were given by altologica exercise.
More tests can be added for sure.

** for running the specs please run:


```
  rspec specs/sale_generator_service_spec.rb
```
